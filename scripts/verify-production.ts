...
const functions = ['send-email','send-reminder','prepare-email-attachment','register-email-attachment','drive-scan','upload-f29-document','reconcile-scheduled-emails','send-f29-deadline-reminders','create-billing-item','update-billing-item','create-payment-link'];
