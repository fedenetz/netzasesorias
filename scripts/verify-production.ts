...
const migrations = ['20260618_add_f22_periods.sql','20260619_add_email_billing_foundation.sql','20260620_refine_f29_operations.sql','20260621_refine_f29_mail_delivery.sql','20260622_admin_billing_navigation.sql','20260623_operational_usability.sql','20260624_security_production_baseline.sql'];
const functions = ['send-email','send-reminder','prepare-email-attachment','register-email-attachment','drive-scan','upload-f29-document','reconcile-scheduled-emails','create-billing-item','update-billing-item','create-payment-link'];
